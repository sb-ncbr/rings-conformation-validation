...
## Description
This repository contains the software workflow from the article by Bučeková *et al.* *Analysis of cyclopentane, cyclohexane, and benzene conformations in ligands for PDB x-ray structures using the Hill-Reilly approach* that has been submitted to the Journal of Cheminformatics.
