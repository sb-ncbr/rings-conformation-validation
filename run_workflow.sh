...
BENZENE="benzene"
ONEDATA_ID=000000000052E8FC67756964233464666266383736383334666338643632316565356135313136316239313733636866613736233536353132643962373637363232356635353333643661396662333364363936636839303432
DATA_FOLDER="input_data"

if [[ "$1" == "-testing" ]]; then
    echo "Testing is ON"
    DATA_FOLDER="input_data_small"
    ONEDATA_ID=000000000052713767756964236664613366353531383739356131343932336331663538386138663466383533636866616565233536353132643962373637363232356635353333643661396662333364363936636839303432
